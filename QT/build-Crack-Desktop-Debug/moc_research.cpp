...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Research_t, stringdata) + ofs \
...
const QMetaObject Research::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Research.data,
      qt_meta_data_Research,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Research.stringdata))
